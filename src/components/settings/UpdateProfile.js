...
const UpdateProfile = () => {
  ...
  return (
    <form onSubmit={(e)=>updateProfile(e)} className="w-11/12 mx-auto my-6 grid grid-cols-2 max-md:grid-cols-1 gap-6 text-black bg-richblack-600 p-4 rounded-md">
      ...
      <div>
        <label htmlFor="gender" className="text-richblack-300">Gender</label>
        <select
      ...
      <div>
        <label htmlFor="dateOfBirth" className="text-richblack-300">Date Of Birth</label>
        <input
            type={"date"}
      ...
      <div>
        <label htmlFor="phonNumber" className="text-richblack-300">Phone Number</label>
        <input
          type={"number"}
      ...
      <button type="submit" className="mx-auto px-2 py-1 bg-yellow-200 text-black active:shadow-sm active:shadow-white hover:scale-95">Save</button>
    </form>
  );
};
