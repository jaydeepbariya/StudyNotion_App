...
const ExploreMore = () => {
  ...
  return (
    <div className="w-11/12 min-h-[300px] flex flex-col text-center my-12">
      ...
      <ul className="flex justify-around bg-richblack-500 rounded-md">
      ...
      <div className="flex justify-between items-center my-6">
        {courses.map((course, index) => {
          return (
            <div
              key={index}
              className="max-w-[30%] text-left px-2 py-1 rounded-sm hover:bg-richblack-400 bg-richblack-600 "
            >
